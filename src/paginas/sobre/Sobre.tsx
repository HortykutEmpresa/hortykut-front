            ...
            <Grid container direction="row" justifyContent="center" alignItems="center" className='caixaSobre'>
                <Grid alignItems="center" item xs={6}>
                    <Box paddingX={20} >
                        ...
                        <Typography className='texto'>Hortykut é um projeto inovador que visa facilitar a conexão entre agricultores, transportadores e comerciantes no setor agrícola. A plataforma oferece um ambiente digital onde esses três atores-chave podem interagir de maneira eficiente e benéfica para todos.
