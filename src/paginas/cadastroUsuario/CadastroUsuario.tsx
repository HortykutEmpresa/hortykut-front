            ...
            <Grid item xs={6} alignItems='center'>
                <Box paddingX={10}>
                    <form onSubmit={onSubmit}>
                        <Typography variant='h3' gutterBottom style={{color:'#FF7B00'}} component='h3' align='center' className='textos2'>Cadastre-se</Typography>
                        ...
                        <Box marginTop={2} textAlign='center'>
                            ...
                            <Button type='submit' variant='contained' style={{backgroundColor:'#FFFD8B', color: 'yellowgreen'}}>
                                Cadastrar
                            </Button>
                        </Box>
                    </form>
